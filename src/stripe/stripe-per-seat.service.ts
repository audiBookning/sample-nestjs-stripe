...
@Injectable()
export class StripePerSeatService {
  ...
  handleInvoicePaid(evt: Stripe.Event) {
    console.log('StripePerSeatService invoice.paid: ', evt);
  ...
  handleInvoicePaymentFailed(evt: Stripe.Event) {
    console.log('StripePerSeatService invoice.payment_failed: ', evt);
    const dataObject = evt.data.object as Stripe.Invoice;
  ...
  handleInvoiceFinalized(evt: Stripe.Event) {
    console.log('StripePerSeatService invoice.finalized: ', evt);
    const dataObject = evt.data.object as Stripe.Invoice;
  ...
  handleCustomerSubsDeleted(evt: Stripe.Event) {
    console.log('StripePerSeatService customer.subscription.deleted: ', evt);
  ...
  handleCustomerSubsTrialEnd(evt: Stripe.Event) {
    console.log(
      'StripePerSeatService customer.subscription.trial_will_end: ',
      evt,
    );
    const dataObject = evt.data.object as Stripe.Subscription;
